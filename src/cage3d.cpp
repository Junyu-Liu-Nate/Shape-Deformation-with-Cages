...
void Cage3D::init(Eigen::Vector3f &coeffMin, Eigen::Vector3f &coeffMax)
{
    ...
    //----- Read in cage
    if (MeshLoader::loadTriMesh("meshes/3d/simple/armadillo/armadillo_cube_cage_complex.obj", vertices, triangles)) {
    ...
    if (MeshLoader::loadTriMesh("meshes/3d/simple/armadillo/armadillo.obj", objectVertices, objectTriangles)) {
