...
//            Vector2f term2 = psi.at(0) * edgeNormal * s + psi.at(1) * edgeNormal * s + psi.at(2) * edgeNormal * s;
//            Vector2f term2 = psi.at(0) * v0.transpose() + psi.at(1) * vIntermidiate.transpose() + psi.at(2) * v1.transpose();
